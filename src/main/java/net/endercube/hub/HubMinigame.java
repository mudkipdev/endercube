...
import net.endercube.event.MinigamePlayerJoinEvent;
import net.endercube.hub.listener.MinigamePlayerJoin;
import net.endercube.hub.listener.PlayerMove;
import net.endercube.parkour.inventory.ParkourMapInventory;
import net.endercube.utility.EndercubePlayer;
import net.endercube.utility.FullbrightDimension;
import net.endercube.utility.NPC;
